...
In Augen des Zwielichts: Königreich der Yōkai haben die Charaktere der Spielenden (SC) Attribute und lösen durch ihr Spiel oder auch Rollenspiel bestimmte Spielzüge aus. Wenn ein Spielzug ausgelöst wird, würfelt der entsprechende Spieler Attributswürfel um zu schauen ob der Spielzug erfolgreich ausgeführt wird oder die Situation misslingt oder sich sogar verkompliziert. 

Die Attributswürfel können schwarz oder weiß sein, je nachdem, ob sie von einem Attribut, einer Hilfestellung oder einer Beeinträchtigung stammen. Klappt nach dem Wurf des Spielenden ein weißer Würfel mit der höchsten Augenzahl, bleibt der Spielzug ohne Konsequenz. Wurden hingegen nach dem Wurf ein schwarzer Würfel mit der höchsten Augenzahl oder ein weißer Würfel mit der selben Augenzahl erzielt, so ist der Charakter in seiner dämonischen Natur stärker korrumpiert.
...
Die Abenteuer in Augen der Zwielichts: Königreich der Yōkai haben keinen vorher definierten Lösungsweg. Die Gruppe spielt darum, eine Erklärung und eine Lösung für ein beschriebenes Problem zu finden. Dazu sammelt sie Hinweise. Je mehr Hinweise sie zusammenfügen können, desto mehr senken sie die Gefahrenstufe des Abenteuers auf den Wert, auf den sie am Ende, mit dem Spielzug "Das Abenteuer lösen",  würfeln müssen. Die Gruppe würfelt aber nicht um zu erfahren, ob ihre Erklärung richtig ist oder nicht, sondern nur, ob die von ihnen konstruierte Lösung so Problemlos funktioniert. 

Ein Beispiel ist eine Stadt, in der nachts immer wieder Kinder verschwinden. Die Gruppe beginnt, die Bevölkerung des Dorfes zu befragen und deckt nach und nach mithilfe der Hinweise auf, dass dies seitdem geschieht, seit die Händler ihr neues Handelszentrum auf einem alten Friedhof gebaut haben.Dieses Problem würde direkt nie im Abenteuer beschrieben werden und wird rein durch die Fantasie der Spielenden mit Hilfe der Hinweise konstruiert. Sollte die Gruppe nun den Wunsch hegen, dieses Problem zu lösen, indem sie das Handelszentrum abreißt und stattdessen einen Tempel zum Beschwichtigen der Geister errichten lässt, so könnte dies durch einen erfolgreichen Wurf auf den Spielzug "Das Abenteuer lösen" erreicht werden.Wäre dieser Wurf jedoch nicht erfolgreich, so würde dem Dorf die Bedeutung des Handelszentrums so sehr am Herzen liegen, dass die Gruppe von den Händlern angegriffen würde. Eventuell würden die Geister die Angelegenheit auch selbst in die Hand nehmen und das Dorf angreifen. Die Kreativität des Spielleiters und der Spielenden kennt hierbei keine Grenzen.
